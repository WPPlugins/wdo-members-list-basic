...
$searchres = mysql_fetch_array($sqls);
...
echo "<table>
	<tr><td id='membersname'>" .$searchres['user_login'] . "</td><td id='membersrank'>" . $userlevel2 . "</td><td id='membersjoined'>" . $searchres['user_registered'] . "</td></tr>
	</table>";
}
else if (empty($searchres)){
